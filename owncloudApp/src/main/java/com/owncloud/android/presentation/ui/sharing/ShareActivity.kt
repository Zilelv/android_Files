    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportFragmentManager.transaction {
            if (savedInstanceState == null && file != null && account != null) {
                ...
                // Files.fm changed Fragment so that only one window is seen in share and made that it is a pop up window
                val fragment = PublicShareDialogFragment.newInstanceToCreate(file, account!!, "")
...
//                )
        ...
        //Files.fm start the popup window
        showAddPublicShare("")
