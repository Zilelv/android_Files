...
import com.filesfm.android.AppRater
import com.filesfm.android.MainApp
import com.filesfm.android.R
import com.filesfm.android.authentication.BiometricManager
import com.filesfm.android.authentication.PassCodeManager
import com.filesfm.android.authentication.PatternManager
...
import com.filesfm.android.db.PreferenceManager.getSortOrder
import com.filesfm.android.extensions.showMessageInSnackbar
import com.filesfm.android.files.services.FileDownloader
import com.filesfm.android.files.services.FileDownloader.FileDownloaderBinder
import com.filesfm.android.files.services.FileUploader
import com.filesfm.android.files.services.FileUploader.FileUploaderBinder
import com.filesfm.android.files.services.TransferRequester
import com.filesfm.android.lib.common.authentication.OwnCloudBearerCredentials
import com.filesfm.android.lib.common.operations.RemoteOperation
...
import com.filesfm.android.operations.CopyFileOperation
import com.filesfm.android.operations.CreateFolderOperation
import com.filesfm.android.operations.MoveFileOperation
import com.filesfm.android.operations.RefreshFolderOperation
import com.filesfm.android.operations.RemoveFileOperation
import com.filesfm.android.operations.RenameFileOperation
import com.filesfm.android.operations.SynchronizeFileOperation
import com.filesfm.android.operations.UploadFileOperation
import com.filesfm.android.syncadapter.FileSyncAdapter
import com.filesfm.android.ui.errorhandling.ErrorMessageAdapter
import com.filesfm.android.ui.fragment.FileDetailFragment
import com.filesfm.android.ui.fragment.FileFragment
import com.filesfm.android.ui.fragment.OCFileListFragment
import com.filesfm.android.ui.fragment.TaskRetainerFragment
import com.filesfm.android.ui.helpers.FilesUploadHelper
import com.filesfm.android.ui.helpers.UriUploader
import com.filesfm.android.ui.preview.PreviewAudioFragment
import com.filesfm.android.ui.preview.PreviewImageActivity
import com.filesfm.android.ui.preview.PreviewImageFragment
import com.filesfm.android.ui.preview.PreviewTextFragment
import com.filesfm.android.ui.preview.PreviewVideoActivity
import com.filesfm.android.ui.preview.PreviewVideoFragment
import com.filesfm.android.utils.DisplayUtils
import com.filesfm.android.utils.Extras
import com.filesfm.android.utils.FileStorageUtils
import com.filesfm.android.utils.PermissionUtil
                        ...
                        if (!synchResult?.isSuccess!!) {
                            ...
                            if (ResultCode.UNAUTHORIZED == synchResult.code ||
                                ...
                                launch(Dispatchers.IO) {
                                    val credentials =
                                        com.filesfm.android.lib.common.accounts.AccountUtils.getCredentialsForAccount(
                                            MainApp.appContext,
                                            account
                                        )
