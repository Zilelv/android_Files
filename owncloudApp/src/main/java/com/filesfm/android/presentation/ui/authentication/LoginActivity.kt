...
package com.filesfm.android.presentation.ui.authentication
...
import com.filesfm.android.authentication.oauth.AuthStateManager
import com.filesfm.android.authentication.oauth.OAuthConnectionBuilder
import com.filesfm.android.authentication.oauth.OAuthUtils
import com.filesfm.android.data.authentication.KEY_USER_ID
import com.filesfm.android.data.authentication.OAUTH2_OIDC_SCOPE
import com.filesfm.android.domain.exceptions.NoNetworkConnectionException
import com.filesfm.android.domain.exceptions.OwncloudVersionNotSupportedException
...
import com.filesfm.android.extensions.parseError
import com.filesfm.android.extensions.showErrorInToast
import com.filesfm.android.lib.common.accounts.AccountTypeUtils
import com.filesfm.android.lib.common.accounts.AccountUtils
...
import com.filesfm.android.presentation.viewmodels.authentication.OCAuthenticationViewModel
import com.filesfm.android.providers.ContextProvider
import com.filesfm.android.ui.dialog.SslUntrustedCertDialog
import com.filesfm.android.utils.DocumentProviderUtils.Companion.notifyDocumentProviderRoots
    ...
    private fun initBrandableOptionsUI() {
        if (!contextProvider.getBoolean(R.bool.show_server_url_input)) {
            ...
            centeredRefreshButton.run {
                //Files.fm removes button "Check Server" and makes automatic check connection
                isVisible = false
                checkOcServer()
