 ...
 */
package com.filesfm.android.operations;
...
import com.filesfm.android.lib.resources.status.GetRemoteStatusOperation;
...
import com.filesfm.android.operations.common.SyncOperation;
    ...
    protected RemoteOperationResult<RemoteCapability> run(OwnCloudClient client) {
        ...
        if (serverVersion != null) {
            ...
            accountMngr.setUserData(
                    ...
                    com.filesfm.android.lib.common.accounts.AccountUtils.Constants.KEY_OC_VERSION,
